...
document.addEventListener('DOMContentLoaded', function() {
    const animateElements = document.querySelectorAll('.project-card, .skill-category, .cert-card, .stat');
    ...
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            statNumbers.forEach((stat, index) => {
                const targets = [15, 5, 23]; // Actual numbers for projects, frameworks, modules
...
console.log(`
🚀 Welcome to Azizah Latifa's QA Portfolio!
📧 Contact: nurazizahlatifah@gmail.com
